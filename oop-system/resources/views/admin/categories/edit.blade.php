...
@section('title')
Edit Category | Library Management System
@endsection
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 mt-5">
                            ...
                            <input type="date" class="form-control" name="date_added" 
                                value="{{ \Carbon\Carbon::parse($category->date_added)->format('Y-m-d') }}">
                        </div> 

                        <div class="col-12 mt-5 text-start">
                            <button type="submit" class="btn btn-primary btn-sm px-5 py-2">Save Category</button>
                        </div>
                    </div>
            </div>
