        ...
        <div class="card-body">
            <form method="POST" action="{{ route('books.update', $book->id) }}">
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" name="name" value="{{$book->name}}">
                    <label for="floatingInput">Title</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" name="isbn" value="{{$book->isbn}}">
                    <label for="floatingPassword">ISBN</label>
                </div>

                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingPassword" placeholder="Password" name="author" value={{$book->author}}>
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                    ...
                    <select class="form-control py-3" name="isActive">
                        <option value="1" {{ $book->isActive ? 'selected' : '' }}>Active</option>
                        <option value="0" {{ !$book->isActive ? 'selected' : '' }}>Inactive</option>
                    </select>
                </div>

                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                    <label for="input-date" class="form-label" value="{{$book->date_added}}">Date Added</label>
                    <input type="date" class="form-control py-3" name="date_added">
                </div>  

                <div class="col-12 mt-5 text-center">
                    <button type="submit" class="btn btn-primary btn-sm px-4 py-2">Update Book</button>
                </div>
            </form>
